...
assert &and[j(P0) eq -147197952000, j(P1) eq 8000, j(P2) eq 54000, j(P3) eq -12288000, j(P4) eq 0, j(P5) eq -3375, j(P6) eq 16581375, j(P7) eq -32768, j(P8) eq -884736000];
tf0,cm0:=HasComplexMultiplication(EllipticCurveFromjInvariant(j(P0)));
assert cm0 eq -67;
tf1,cm1:=HasComplexMultiplication(EllipticCurveFromjInvariant(j(P1)));
assert cm1 eq -8;
tf2,cm2:=HasComplexMultiplication(EllipticCurveFromjInvariant(j(P2)));
assert cm2 eq -12;
...
assert cm6 eq -28;
tf7,cm7:=HasComplexMultiplication(EllipticCurveFromjInvariant(j(P7)));
assert cm7 eq -11;
